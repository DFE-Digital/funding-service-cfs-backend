...
using CalculateFunding.Services.Publishing.FundingManagement.ProviderGroupingDataBackfilling;
...
namespace CalculateFunding.Functions.Publishing
{
    public class Startup 
    {
        ...
        public static IServiceProvider Register(IServiceCollection builder,
            IConfiguration config)
        {
            ...
            builder.AddSingleton<IPublishedFundingBulkRepository, PublishedFundingBulkRepository>((ctx) =>
            {
                ...
                CosmosRepository calcsCosmosRepository = (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development")
                    ? new CosmosRepository(settings, publishingEngineOptions.AllowBatching ? new CosmosClientOptions
                    {
            ...
            if (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development")
            {
                ...
                builder.AddScoped<OnProviderGroupingDataBackfilling>();
                builder.AddScoped<OnProviderGroupingDataBackfillingFailure>();
                builder.AddScoped<OnReleaseProvidersToChannels>();
                builder.AddScoped<OnReleaseProvidersToChannelsFailure>();
                builder.AddScoped<OnReprofilingOnDemand>();
                builder.AddScoped<OnReprofilingOnDemandFailure>();
            }
            ...
            builder.AddScoped<IReprofilingOnDemandService, ReprofilingOnDemandService>();
            ...
            builder.AddTransient<IVariationStrategy, ClosedProviderReProfilingVariationStrategy>();
            ...
            builder.AddSingleton<IVersionBulkRepository<PublishedProviderVersion>, VersionBulkRepository<PublishedProviderVersion>>((ctx) =>
            {
                ...
                CosmosRepository cosmosRepository = (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development")
                    ? new CosmosRepository(PublishedProviderVersioningDbSettings, publishingEngineOptions.AllowBatching ? new CosmosClientOptions
                    {
                        ConnectionMode = ConnectionMode.Gateway,
                        RequestTimeout = new TimeSpan(0, 0, 15),
                        ConsistencyLevel = ConsistencyLevel.Eventual,
            ...
            builder.AddSingleton<IVersionBulkRepository<PublishedFundingVersion>, VersionBulkRepository<PublishedFundingVersion>>((ctx) =>
            {
                ...
                CosmosRepository cosmosRepository = (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development")
                    ? new CosmosRepository(PublishedFundingVersioningDbSettings, publishingEngineOptions.AllowBatching ? new CosmosClientOptions
                    {
                        ConnectionMode = ConnectionMode.Gateway,
                        RequestTimeout = new TimeSpan(0, 0, 15),
                        ConsistencyLevel = ConsistencyLevel.Eventual,
            ...
            {
                builder.AddSingleton<ICalculationResultsRepository, CosmosCalculationResultsRepository>((ctx) =>
                {
                    CosmosDbSettings calssDbSettings = new CosmosDbSettings();
                    ...
                    CosmosRepository calcsCosmosRepository = (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Development")
                        ? new CosmosRepository(calssDbSettings, new CosmosClientOptions
                        {
                            ConnectionMode = ConnectionMode.Gateway,
                            RequestTimeout = new TimeSpan(0, 0, 15),
                            ConsistencyLevel = ConsistencyLevel.Eventual,
                    ...
                    return new CosmosCalculationResultsRepository(calcsCosmosRepository);
                });
            }
            ...
            builder.AddLogging("CalculateFunding.Functions.Publishing", (IConfigurationRoot)config);
            ...
            builder.AddScoped<IProviderGroupingDataBackfillingService, ProviderGroupingDataBackfillingService>();
            builder.AddScoped<IExistingPublishedFundingDataBackfilling, ExistingPublishedFundingDataBackfillings>();
