namespace CalculateFunding.Services.Core.Constants
{
    public static class JobConstants
    {
        public static class DefinitionNames
        {
            ...
            public const string ReprofilingOnDemandJob = nameof(ReprofilingOnDemandJob);

            public const string ProviderGroupingDataBackfillingJob = nameof(ProviderGroupingDataBackfillingJob);
        }
