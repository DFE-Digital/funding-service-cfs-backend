namespace CalculateFunding.Services.Core.Constants
{
    public static class ServiceBusConstants
    {
        ...
        public static class QueueNames
        {
            ...
            public const string ProviderGroupingDataBackfilling = "provider-grouping-data-backfilling";

            public const string ProviderGroupingDataBackfillingPoisoned = "provider-grouping-data-backfilling/$DeadLetterQueue";

            public const string ProviderGroupingDataBackfillingPoisonedLocal = "provider-grouping-data-backfilling-poisoned";

            public const string ReprofilingOnDemand = "reprofiling-on-demand";

            public const string ReprofilingOnDemandPoisoned = "reprofiling-on-demand-poisoned/$DeadLetterQueue";

            public const string ReprofilingOnDemandPoisonedLocal = "reprofiling-on-demand-poisoned";
        }
