namespace CalculateFunding.Services.Core.Constants
{
    public static class FunctionConstants
    {
        ...
        public const string ProviderGroupingDataBackfilling = "on-provider-grouping-data-backfilling";

        public const string ProviderGroupingDataBackfillingPoisoned = "on-provider-grouping-data-backfilling-poisoned";
        ...
        public const string ReprofilingOnDemand = "on-reprofiling-on-demand";

        public const string ReprofilingOnDemandPoisoned = "on-reprofiling-on-demand-poisoned";

        public const string PublishingRefreshFunding = "on-publishing-refresh-funding";

        public const string PublishingRefreshFundingPoisoned = "on-publishing-refresh-funding-poisoned";
