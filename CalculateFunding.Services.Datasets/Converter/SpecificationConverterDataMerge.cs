...
namespace CalculateFunding.Services.Datasets.Converter
{
    public class SpecificationConverterDataMerge : JobProcessingService, ISpecificationConverterDataMerge
    {
        ...
        {
            return _datasets.IsConnectedToSQL() 
                ? await _datasetsResilience.ExecuteAsync(() => _datasets.GetDefinitionSpecificationRelationshipsBySQLQuery(_ =>
                    _.SpecificationId == specificationId && !_.IsDeleted && _.IsLatest))
