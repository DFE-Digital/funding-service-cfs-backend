            ...
            IDatasetsResiliencePolicies datasetsResiliencePolicies)
        {
            ...
            RuleFor(model => model.DatasetDefinitionId)
               .Custom((name, context) =>
               {
                   ...
                   if ((relationshipModel.RelationshipType == DatasetRelationshipType.Uploaded || relationshipModel.RelationshipType == DatasetRelationshipType.FDS) && string.IsNullOrWhiteSpace(relationshipModel.DatasetDefinitionId))
                   {
