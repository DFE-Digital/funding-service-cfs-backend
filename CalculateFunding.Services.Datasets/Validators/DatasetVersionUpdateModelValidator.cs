    ...
    public class DatasetVersionUpdateModelValidator : AbstractValidator<DatasetVersionUpdateModel>
    {
        ...
        public async Task<IEnumerable<JobSummary>> GetNonCompletedConverterJobs(string datasetId)
        {
            ...
            IEnumerable<DefinitionSpecificationRelationship> definitionSpecificationRelationships = _datasetRepository.IsConnectedToSQL()
                ? await _datasetRepositoryPolicies.ExecuteAsync(() => _datasetRepository.GetDefinitionSpecificationRelationshipsBySQLQuery(_ => _.DatasetId == datasetId && _.IsLatest && !_.IsDeleted && _.ConverterEnabled))
                : await _datasetRepositoryPolicies.ExecuteAsync(() => _datasetRepository.GetDefinitionSpecificationRelationshipsByQuery(_ => _.Content.DatasetId == datasetId && _.Content.Current.ConverterEnabled));
