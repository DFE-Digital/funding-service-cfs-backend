...
namespace CalculateFunding.Services.Datasets.Interfaces
{
    public interface IDefinitionSpecificationRelationshipService
    {
        ...
        Task<IActionResult>UpdateFDSDatasetSchemaVersionOfRelationship(UpdateFDSDatasetSchemaVersionModel updateFDSDatasetSchemaVersionModel,
            Reference user);
        ...
        Task<IActionResult> GetNewFDSDatasetSchemaVersion(string fundingStreamCode, string fundingPeriodCode, string datasetDefinitionName);
        Task<IActionResult> GetFDSDatasetComparisonResult(DatasetComparisonRequestModel model);
    }
}
