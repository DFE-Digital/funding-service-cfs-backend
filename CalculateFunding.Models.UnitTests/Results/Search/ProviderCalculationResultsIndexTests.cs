...
namespace CalculateFunding.Models.UnitTests.Results.Search
{
    ...
    public class ProviderCalculationResultsIndexTests
    {
        ...
        {
            string jsonPath = GetProviderCalculationResultsSchemaPath();
        ...
        private static string GetProviderCalculationResultsSchemaPath()
        {
            ...
            while (directory != null)
            {
                var candidate = Path.Combine(
                    ...
                    "DevOps",
                    "search-indexes",
                    "providercalculationresultsindex",
                    "providercalculationresultsindex.json");
            ...
            throw new FileNotFoundException(
                "Unable to locate providercalculationresultsindex.json");
        }
    }
}
