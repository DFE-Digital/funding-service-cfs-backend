...
using EFCoreUoW = CalculateFunding.Common.EfCore.UnitOfWork;
...
namespace CalculateFunding.Functions.Results
{
    public class Startup 
    {
        ...
        private static IServiceProvider Register(IServiceCollection builder, IConfigurationRoot config)
        {
            ...
            builder.AddSingleton<ICalculationResultsRepository, CosmosCalculationResultsRepository>();
            ...
            builder.AddScoped<IProviderCalculationResultsReIndexerService, ProviderCalculationResultsReIndexerService>();
            ...
            var useSQLDB = config.GetValue<bool>("UseSQLDB");
            if (useSQLDB)
            {
                ...
                builder.AddTransient<EFCoreUoW.IUnitOfWork, EFCoreUoW.UnitOfWork>(ctx => new EFCoreUoW.UnitOfWork(ctx.GetRequiredService<EntityModel.CfsDbContext>()));

                builder.AddScoped<ICalculationResultsRepository, CalculationResultsRepository>();
                builder.AddScoped<IProviderSourceDatasetRepository, ProviderSourceDatasetRepository>();
            }
                ...
                builder.AddSingleton<ICalculationResultsRepository, CosmosCalculationResultsRepository>((ctx) =>
            {
                ...
                return new CosmosCalculationResultsRepository(calcsCosmosRepostory, engineSettings);
            });

                builder.AddSingleton<IProviderSourceDatasetRepository, CosmosProviderSourceDatasetRepository>((ctx) =>
                {
                    ...
                    return new CosmosProviderSourceDatasetRepository(calcsCosmosRepostory);
                });
            }
