...
namespace CalculateFunding.Api.Providers
{
    public class Startup
    {
        ...
        public void RegisterComponents(IServiceCollection builder)
        {
            ...
            builder.AddScoped<IValidator<SetFundingStreamCurrentProviderVersionRequest>, SetFundingStreamCurrentProviderVersionRequestValidator>();
            builder.AddScoped<IFundingStreamProviderVersionService, FundingStreamProviderVersionService>();
            ...
            builder
                .AddScoped<IProviderVersionService, ProviderVersionService>()
                .AddScoped<IProviderSnapshotPersistService, ProviderSnapshotPersistService>()
                .AddScoped<IHealthChecker, ProviderVersionService>();

            builder
                .AddScoped<IProviderVersionSearchService, ProviderVersionSearchService>()
                .AddScoped<IHealthChecker, ProviderVersionSearchService>();

            builder
                .AddSingleton<IJobManagement, JobManagement>();

            builder
                .AddScoped<IScopedProvidersService, ScopedProvidersService>()
                .AddScoped<IHealthChecker, ScopedProvidersService>();

            builder
                .AddScoped<IProviderVersionUpdateCheckService, ProviderVersionUpdateCheckService>()
                .AddScoped<IPublishingJobClashCheck, PublishingJobClashCheck>();
            ...
            {
                builder
                 .AddScoped<IProviderVersionsMetadataRepository, ProviderVersionsMetadataRepository>();
            }
            else
            {

                builder.AddSingleton<IProviderVersionsMetadataRepository, CosmosProviderVersionsMetadataRepository>(
                ctx =>
                {
                    ...
                    return new CosmosProviderVersionsMetadataRepository(cosmosRepository);
                });
            }
