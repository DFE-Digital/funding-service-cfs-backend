...
namespace CalculateFunding.Migrations.Specification.Clone
{
    internal class BootStrapper
    {
        ...
        private const string SourceFdsClientKey = "SourceFDS";
        private const string TargetFdsClientKey = "TargetFDS";
        ...
        public static IServiceProvider BuildServiceProvider()
        {
            ...
            serviceCollection.AddFdsInterServiceClient(Configuration, handlerLifetime: Timeout.InfiniteTimeSpan, clientKey: SourceFdsClientKey, clientName: "source:fdsClient");
            serviceCollection.AddFdsInterServiceClient(Configuration, handlerLifetime: Timeout.InfiniteTimeSpan, clientKey: TargetFdsClientKey, clientName: "target:fdsClient");
            ...
            serviceCollection.AddSingleton<IBatchCloneResiliencePolicies>(ctx =>
            {
                ...
                return new BatchCloneResiliencePolicies
                {
                    ...
                    DatasetsApiClient = ResiliencePolicyHelpers
                        .GenerateRestRepositoryPolicy(totalNetworkRequestsPolicy),
                    FdsApiClient = ResiliencePolicyHelpers.GenerateRestRepositoryPolicy(totalNetworkRequestsPolicy),
                };
            });
            ...
            serviceCollection.AddSingleton<ISourceApiClient>(ctx =>
            {
                ...
                IFDSApiClient fdsApiClient = new FDSApiClient(httpClientFactory, logger, cancellationTokenProvider, clientKey: SourceFdsClientKey);
            ...
            serviceCollection.AddSingleton<ITargetApiClient>(ctx =>
            {
                ...
                IFDSApiClient fdsApiClient = new FDSApiClient(httpClientFactory, logger, cancellationTokenProvider, clientKey: TargetFdsClientKey);
