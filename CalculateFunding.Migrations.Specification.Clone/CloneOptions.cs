...
namespace CalculateFunding.Migrations.Specification.Clone
{
    public class CloneOptions
    {
        ...
        [Option("convert-uploaded-data-to-fds-data", Required = false, HelpText = "Flag to include or exclude cloning fds data", Default = false)]
        public bool? ConvertUploadedDataToFDSData { get; set; }
    }
}
