    ...
    public class CalculationsFunctions : SmokeTestBase
    {
        ...
        public async Task OnUpdateCodeContextCache_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.ApplyTemplateCalculations,
                async(ServiceBusReceivedMessage smokeResponse) => await onApplyTemplateCalculations.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))), useSession: true);
        ...
        public async Task CalcsAddRelationshipToBuildProject_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.UpdateBuildProjectRelationships,
                async(ServiceBusReceivedMessage smokeResponse) => await calcsAddRelationshipToBuildProject.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))));
        ...
        public async Task OnCalcsInstructAllocationResults_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.CalculationJobInitialiser, 
                async(ServiceBusReceivedMessage smokeResponse) => await onCalcsInstructAllocationResults.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))), useSession: true);
        ...
        public async Task OnCalculationAggregationsJobCompleted_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.TopicSubscribers.CreateInstructAllocationsJob,
                async(ServiceBusReceivedMessage smokeResponse) => await onCalculationAggregationsJobCompleted.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
        ...
        public async Task OnDataDefinitionChanges_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.TopicSubscribers.UpdateCalculationFieldDefinitionProperties,
                async(ServiceBusReceivedMessage smokeResponse) => await onDataDefinitionChanges.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
        ...
        public async Task OnDeleteCalculations_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.DeleteCalculations,
                async(ServiceBusReceivedMessage smokeResponse) => await onDeleteCalculations.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))));
