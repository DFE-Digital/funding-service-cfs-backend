...
namespace CalculateFunding.Api.Policy.IntegrationTests
{
    ...
    public class FundingPeriodApiTests : IntegrationTest
    {
        ...
        public async Task ShouldSaveValidFundingPeriod()
        {
            ...
            await ThenRemoveFundingPeriod(fundingPeriodParameters);
        }
        ...
        private async Task ThenRemoveFundingPeriod(FundingPeriodParameters fundingPeriodParameters)
        {
            await _fundingPeriodDataContext.RemoveContextData(fundingPeriodParameters);
        }
