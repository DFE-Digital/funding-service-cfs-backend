...
namespace CalculateFunding.Api.Policy.IntegrationTests
{
    ...
    {
        private FundingConfigurationSqlDataContext _fundingConfigurationDataContext;
        private FundingStreamSqlDataContext _fundingStreamDataContext;
        private FundingPeriodSqlDataContext _fundingPeriodDataContext;
        ...
        public void Setup()
        {
            _fundingConfigurationDataContext = new FundingConfigurationSqlDataContext(Configuration);
            _fundingStreamDataContext = new FundingStreamSqlDataContext(Configuration);
            _fundingPeriodDataContext = new FundingPeriodSqlDataContext(Configuration);
        ...
        {
            string fundingStreamId = NewRandomString().Substring(0,6);
            string fundingPeriodId = NewRandomString();
            string defaultTemplateVersion = "1.0";
            string allowedPublishedFundingStreamId = NewRandomString().Substring(0, 6);
