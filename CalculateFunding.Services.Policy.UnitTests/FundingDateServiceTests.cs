...
namespace CalculateFunding.Services.Policy
{
    ...
    public class FundingDateServiceTests
    {
        ...
        public async Task SaveFundingDate_GivenInvalidSaveFundingDateResult_ReturnsSaveFundingDateResult()
        {
            ...
            logger
            .Received(1)
            .Error(Arg.Is($"Failed to save funding date for funding stream id: {_fundingStreamId} and period id: {_fundingPeriodId} and funding line id: {_fundingLineId} to DB with status {(int)statusCode}"));
        }
        ...
        public async Task SaveFundingDate_GivenValidViewModel_ReturnsOkResult()
        {
            ...
            logger
            .Received(1)
            .Information(Arg.Is($"Successfully saved funding date for funding stream id: {_fundingStreamId} and period id: {_fundingPeriodId} and funding line id: {_fundingLineId} to DB"));
        }
