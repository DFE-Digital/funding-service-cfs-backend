    ...
    public class RestoreTemplateUnitTests
    {
        ...
        public RestoreTemplateUnitTests()
        {
            _command = new TemplateFundingLinesUpdateCommand
            {
                ...
                TemplateFundingLinesJson = @"[{""templateLineId"":1,""type"":""Payment"",""name"":""Funding Line 1"",""externalFundingLineName"":""Funding Line external"",""fundingLineCode"":""DSG-001"",""fundingLines"":[],""calculations"":[]}]"
            };
            ...
            _service = new TemplateBuilderService(
                ...
                Substitute.For<ILogger>(),_configuration);
        ...
        private void SetupMocks()
        {
            ...
            _configuration.Bind("UseSQLDB", false);
        }
