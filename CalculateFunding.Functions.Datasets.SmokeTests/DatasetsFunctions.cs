    ...
    public class DatasetsFunctions : SmokeTestBase
    {
        ...
        public async Task OnCreateSpecificationConverterDatasetsMerge_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.RunConverterDatasetMerge,
                async smokeResponse => await onRunConverterDataMerge.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
                useSession: true);
        ...
        public async Task OnConverterWizardActivityCsvGeneration_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.ConverterWizardActivityCsvGeneration,
                async smokeResponse => await onConverterWizardActivityCsvGeneration.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
                useSession: true);
        ...
        public async Task OnDataDefinitionChanges_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.TopicSubscribers.UpdateDataDefinitionName,
                async smokeResponse => await onDataDefinitionChanges.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
        ...
        public async Task OnMapFdzDatasetsEventFired_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.MapFdzDatasets,
                async smokeResponse => await onMapFdzDatasetsEventFired.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
                useSession: true);
        ...
        public async Task OnDatasetEventFired_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.ProcessDataset,
                async smokeResponse => await onDatasetEvent.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
                useSession: true);
        ...
        public async Task OnDatasetValidationEventFired_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.ValidateDataset,
                async smokeResponse => await onDatasetValidationEvent.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))), useSession:true);
        ...
        public async Task OnDeleteDatasets_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.DeleteDatasets,
                async smokeResponse => await onDeleteDatasets.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))));
        ...
        public async Task OnProcessDatasetObsoleteItems_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.ProcessDatasetObsoleteItems,
                async smokeResponse => await onProcessDatasetObsoleteItems.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
                useSession: true);
