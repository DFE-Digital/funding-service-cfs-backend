    ...
    public class ResultsFunctions : SmokeTestBase
    {
        ...
        public async Task OnCalculationResultsCsvGeneration_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.CalculationResultsCsvGeneration,
                async (ServiceBusReceivedMessage smokeResponse) => await onCalculationResultsCsvGeneration.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))), useSession: true);
        ...
        public async Task OnProviderResultsSpecificationCleanup_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.TopicSubscribers.CleanupCalculationResultsForSpecificationProviders,
                async (ServiceBusReceivedMessage smokeResponse) => await onProviderResultsSpecificationCleanup.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))),
        ...
        public async Task OnReIndexCalculationResults_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.ReIndexCalculationResultsIndex,
                async (ServiceBusReceivedMessage smokeResponse) => await onReIndexCalculationResults.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))));
        ...
        public async Task OnDeleteCalculationResults_SmokeTestSucceeds()
        {
            ...
            SmokeResponse response = await RunSmokeTest(ServiceBusConstants.QueueNames.DeleteCalculationResults,
                async (ServiceBusReceivedMessage smokeResponse) => await onDeleteCalculationResults.Run(JsonConvert.DeserializeObject<ServiceBusReceivedMessage>(Encoding.UTF8.GetString(smokeResponse.Body))));
