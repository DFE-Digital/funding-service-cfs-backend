...
namespace CalculateFunding.Api.Results.Controllers
{
    public class ResultsController : ControllerBase
    {
        ...
        [Route("api/results/aggregateCalculationResults/{specificationId}")]
        [HttpPost]
        [Produces(typeof(AggregateCalculationResults))]
        public async Task<IActionResult> GetAggregateCalculationResults([FromRoute] string specificationId, [FromBody] IEnumerable<string> calculationIds)
        {
            return await _resultsService.GetAggregateCalculationResults(specificationId, calculationIds);
        }
