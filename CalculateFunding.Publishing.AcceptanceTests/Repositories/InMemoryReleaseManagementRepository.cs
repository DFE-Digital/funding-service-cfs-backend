...
namespace CalculateFunding.Publishing.AcceptanceTests.Repositories
{
    public class InMemoryReleaseManagementRepository : IReleaseManagementRepository
    {
        ...
        public Task<int> QueryPublishedFundingCount(int channelId, int? ukprn, int? version, IEnumerable<string> fundingStreamIds, IEnumerable<string> fundingPeriodIds)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<ExternalFeedFundingGroupItem>> QueryPublishedFunding(int channelId, int? ukprn, int? version, IEnumerable<string> fundingStreamIds, IEnumerable<string> fundingPeriodIds, int top, int? pageRef, int totalCount)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<FundingGroupId>> QueryFundingId(int channelId, IEnumerable<string> fundingStreamIds, IEnumerable<string> fundingPeriodIds)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<LatestFundingGroupVersion>> GetLatestFundingGroupVersion(string specificationId)
        {
            throw new NotImplementedException();
        }

        public Task UpdateFundingGroupVersionWithTotalFunding(string fundingGroupVersionId, decimal? totalFunding)
        {
            throw new NotImplementedException();
        }

        public Task<bool> IsExistsFundingGroupVersion(string fundingId)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<ReleasedProviderVersionChannel>> GetReleasedProviderVersionChannelUsingAmbientTransation(string specificationId, string providerId, int channelId)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<LatestFundingGroupVersionInProviderChannel>> IReleaseManagementRepository.GetLatestFundingGroupVersion(string specificationId)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<ReleasedProviderVersionChannelData>> GetReleasedProviderVersionChannel(string specificationId, int channelId)
        {
            throw new NotImplementedException();
        }
    }
