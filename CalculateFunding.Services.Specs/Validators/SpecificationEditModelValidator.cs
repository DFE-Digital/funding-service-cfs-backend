            ...
            ISpecificationsResiliencePolicies resiliencePolicies)
        {
            ...
            RuleFor(model => model.Name)
               ...
               .Custom((name, context) =>
               {
                   ...
                   {
                       IEnumerable<Specification> specifications = _specificationsRepository.GetSpecificationsBySQLQuery(m => m.SpecificationName.ToLower() == specModel.Name.Trim().ToLower() && m.SpecificationId != specModel.SpecificationId).Result;
