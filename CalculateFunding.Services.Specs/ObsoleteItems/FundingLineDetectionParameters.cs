...
namespace CalculateFunding.Services.Specs.ObsoleteItems
{
    public class FundingLineDetectionParameters
    {
        ...
        public FundingLineDetectionParameters(ServiceBusReceivedMessage message)
        {
        ...
        public static implicit operator FundingLineDetectionParameters(ServiceBusReceivedMessage message)
        {
            return new FundingLineDetectionParameters(message);
        }

        private string MessageProperty(ServiceBusReceivedMessage message,
            string key)
