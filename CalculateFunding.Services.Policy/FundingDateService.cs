            ...
            FundingDateViewModel fundingDateViewModel)
        {
            ...
            try
            {
                ...
                if (!result.IsSuccess())
                {
                    ...
                    string errorMessage = $"Failed to save funding date for funding stream id: {fundingStreamId} and period id: {fundingPeriodId} and funding line id: {fundingLineId} to DB with status {statusCode}";
            ...
            {
                string errorMessage = $"Exception occurred writing to funding date for funding stream id: {fundingStreamId} and period id: {fundingPeriodId} and funding line id: {fundingLineId} to DB";
            ...
            _logger.Information($"Successfully saved funding date for funding stream id: {fundingStreamId} and period id: {fundingPeriodId} and funding line id: {fundingLineId} to DB");
