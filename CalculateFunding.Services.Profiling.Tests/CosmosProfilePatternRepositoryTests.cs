...
{
    [TestClass]
    public class CosmosProfilePatternRepositoryTests
    {
        private readonly Mock<ICosmosRepository> _mockCosmoRepository;
        private readonly CosmosProfilePatternRepository _repository;
        private readonly FundingStreamPeriodProfilePatternBuilder _fundingStreamPeriodProfilePatternBuilder;

        public CosmosProfilePatternRepositoryTests()
        {
            _mockCosmoRepository = new Mock<ICosmosRepository>();
            _repository = new CosmosProfilePatternRepository(_mockCosmoRepository.Object);
