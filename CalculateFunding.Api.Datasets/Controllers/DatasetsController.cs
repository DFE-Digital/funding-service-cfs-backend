...
namespace CalculateFunding.Api.Datasets.Controllers
{
    public class DatasetsController : ControllerBase
    {
        ...
        [Route("api/datasets/update-fds-dataschema-version-of-relationship")]
        [HttpPost]
        [Produces(typeof(UpdateFDSDataSchemaResponseModel))]
        public Task<IActionResult> UpdateFDSDatasetSchemaVersionOfRelationship([FromBody] UpdateFDSDatasetSchemaVersionModel updateFDSDatasetSchemaVersionModel)
        {
            Reference user = ControllerContext.HttpContext.Request.GetUserOrDefault();

            return _definitionSpecificationRelationshipService.UpdateFDSDatasetSchemaVersionOfRelationship(updateFDSDatasetSchemaVersionModel, user);
        }
        ...
        [Route("api/datasets/get-fds-dataschema-comparision-Results")]
        [HttpPost]
        [ProducesResponseType(200, Type = typeof(DatasetComparisonResponseModel))]
        public Task<IActionResult> GetFDSDatasetComparisonResult([FromBody] DatasetComparisonRequestModel datasetUpgradeModel)
        {
            return _definitionSpecificationRelationshipService.GetFDSDatasetComparisonResult(datasetUpgradeModel);
        }
        ...
        [Route("api/datasets/get-new-fds-dataschema-version")]
        [HttpGet]
        [Produces(typeof(DatasetDefinitionViewModel))]
        public Task<IActionResult> GetNewFDSDatasetSchemaVersion([FromQuery] string fundingStreamCode, [FromQuery] string fundingPeriodCode, [FromQuery] string datasetDefinitionName)
        {
            return _definitionSpecificationRelationshipService.GetNewFDSDatasetSchemaVersion(fundingStreamCode, fundingPeriodCode, datasetDefinitionName);
        }
    }
}
