...
{
    public class CosmosProviderVersionsMetadataRepository : IProviderVersionsMetadataRepository, IHealthChecker
    {
        readonly ICosmosRepository _cosmos;

        public CosmosProviderVersionsMetadataRepository(ICosmosRepository cosmosCosmos)
        {
