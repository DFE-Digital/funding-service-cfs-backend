...
{
    public abstract class JobCreationForReprofilingOnDemand : ICreateJobsForReprofilingOnDemand
    {
        private readonly IJobManagement _jobManagement;
        private readonly ILogger _logger;

        protected JobCreationForReprofilingOnDemand(IJobManagement jobManagement,
            ILogger logger,
            ...
            bool compress = false)
        {
            ...
            {
                string error = $"Failed to queue reprofiling on demand with id: {specificationId}";
