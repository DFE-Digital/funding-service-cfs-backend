...
{
    public class ReProfileOnDemandPrerequisiteChecker : BasePrerequisiteChecker, IPrerequisiteChecker
    {
        public override string Name => "ReProfileOnDemand";
        ...
        public ReProfileOnDemandPrerequisiteChecker(
            ...
            IEnumerable<Provider> providers)
        {
            ...
            {
                _logger.Error("Specification failed reprofiling prerequisite check. Reason: no scoped providers");
            ...
            {
                string errorMessage = "Funding can not be reprofiled due to calculation errors.";
        ...
        {
            return type == PrerequisiteCheckerType.ReProfileOnDemand;
        }
    }
}
