    ...
    public class RefreshPrerequisiteChecker : BasePrerequisiteChecker, IPrerequisiteChecker
    {
            ...
            IEnumerable<Provider> providers)
        {
            ...
            foreach (Reference fundingStream in specification.FundingStreams) 
            {
                ...
                var calculationPatternType = fundingStreamPeriodProfilePatterns.Where(x => x.ProfilePatternType == ProfilePatternType.Calculation);
                ...
                if (fundingStreamPeriodProfilePatterns.Any() && calculationPatternType.Any())
                {
