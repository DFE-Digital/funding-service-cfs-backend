...
namespace CalculateFunding.Services.Publishing.Undo
{
    public class PublishedFundingUndoJobParameters
    {
        ...
        public PublishedFundingUndoJobParameters(ServiceBusReceivedMessage message)
        {
        ...
        public static implicit operator PublishedFundingUndoJobParameters(ServiceBusReceivedMessage message)
        {
        ...
        protected static string GetUserProperty(ServiceBusReceivedMessage message, string name) 
            => message.ApplicationProperties.TryGetValue(name, out object property) ? property?.ToString() : 
