...
namespace CalculateFunding.Services.Publishing.FundingManagement.Interfaces
{
    public interface IReleaseManagementRepository
    {
        ...
        Task UpdateFundingGroupVersionWithTotalFunding(string fundingGroupVersionId, decimal? totalFunding);
        ...
        Task<IEnumerable<ReleasedProviderVersionChannel>> GetReleasedProviderVersionChannelUsingAmbientTransation(string specificationId, string providerId, int channelId);
        ...
        Task<IEnumerable<FundingGroupId>> QueryFundingId(
                    int channelId,
                    IEnumerable<string> fundingStreamIds,
                    IEnumerable<string> fundingPeriodIds
                    );

        Task<IEnumerable<LatestFundingGroupVersionInProviderChannel>> GetLatestFundingGroupVersion(string specificationId);
        Task<bool> IsExistsFundingGroupVersion(string fundingId);

        Task<IEnumerable<ReleasedProviderVersionChannelData>> GetReleasedProviderVersionChannel(string specificationId, int channelId);
    }
}