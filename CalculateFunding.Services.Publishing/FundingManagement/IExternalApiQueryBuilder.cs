...
namespace CalculateFunding.Services.Publishing.FundingManagement
{
    public interface IExternalApiQueryBuilder
    {
        ...
        (string sql, object parameters) BuildCountQuery(int channelId, int? ukprn, int? version, IEnumerable<string> fundingStreamIds, IEnumerable<string> fundingPeriodIds);
        (string sql, object parameters) BuildQuery(int channelId, int? ukprn, int? version, IEnumerable<string> fundingStreamIds, IEnumerable<string> fundingPeriodIds, int top, int? pageRef, int totalCount);
        (string sql, object parameters) BuildFundingIdQuery(int channelId, IEnumerable<string> fundingStreamIds, IEnumerable<string> fundingPeriodIds);
    }
}