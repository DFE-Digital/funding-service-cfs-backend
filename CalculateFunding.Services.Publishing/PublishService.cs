...
namespace CalculateFunding.Services.Publishing
{
    public class PublishService : JobProcessingService, IPublishService
    {
        ...
        public PublishService(IPublishedFundingStatusUpdateService publishedFundingStatusUpdateService,
            ...
            IPoliciesService policiesService) : base(jobManagement, logger)
        {
        ...
        public async Task PublishProviderFundingResults(ServiceBusReceivedMessage message, bool batched = false)
        {
            ...
            bool publishFundingJobWithv3Only = true)
        {
            ...
            try
            {
                ...
                {
                    _logger.Information($"No Need to Save the blob for V3");
