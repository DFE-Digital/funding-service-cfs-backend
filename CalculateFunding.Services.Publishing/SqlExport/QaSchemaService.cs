...
namespace CalculateFunding.Services.Publishing.SqlExport
{
    public class QaSchemaService : IQaSchemaService
    {
            ...
            SqlExportSource sqlExportSource)
        {
            ...
            _logger.Information("SQL Import Pre Req starts");
            ...
            {
                _logger.Warning("SqlImport PrePreq check failure");
                throw new NonRetriableException(ex.Message, ex);
            }
            _logger.Information("SQL Import Pre Req completed");
            ...
            SqlExportSource sqlExportSource)
        {
            ...
            _logger.Information("Table Creation completed");
        ...
        string fundingStreamId)
        {
            ...
            _logger.Information("Provider version fetched successfully");
            ...
            IQaRepository qaRepository)
        {
            ...
            _logger.Information("Drop Table completed successfully");
        }
        ...
        private async Task<UniqueTemplateContents> GetTemplateData(SpecificationSummary specification, string fundingStreamId)
        {
            ...
            _logger.Information("Template data fetched successfully");
        ...
        private IEnumerable<SqlColumnDefinition> GetSqlColumnDefinitionsForCalculations(IEnumerable<Calculation> calculations)
        {
            ...
            {
                string Name = $"Calc_{calculation.TemplateCalculationId}_{_sqlNames.GenerateIdentifier(calculation.Name)}";
                // Story 272641 - Trim to max 128 characters
                var trimmedName = Name.Length > 128
        ...
        private async Task<TemplateMetadataContents> GetTemplateMetadataContents(SpecificationSummary specification, string fundingStreamId)
        {
            ...
            _logger.Information("Template Metadata contents fetched succesfully");
