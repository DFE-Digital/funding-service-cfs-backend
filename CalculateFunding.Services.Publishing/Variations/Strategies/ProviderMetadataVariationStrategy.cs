...
namespace CalculateFunding.Services.Publishing.Variations.Strategies
{
    ...
    public class ProviderMetadataVariationStrategy : VariationStrategy, IVariationStrategy
    {
        private class VariationCheck
        {
            ...
            public readonly VariationReason _variationReason;
            ...
            {
                return _priorStateAccessor.Name;
            }
        }
        ...
        static ProviderMetadataVariationStrategy()
        {
         ...
         static readonly VariationCheckWithSchemaVersions[] VariationChecks;
        ...
        protected override async Task<bool> Determine(ProviderVariationContext providerVariationContext, FundingConfiguration fundingConfiguration = null)
        {
            ...
            {
                string propertyName = variationCheck.GetPropertyName();

                if (fundingConfiguration.NonRestrictedProviderMetaData != null && fundingConfiguration.NonRestrictedProviderMetaData.Any())
                {                  
                    List<string> nonRestrictedProviderMetaDataList = fundingConfiguration.NonRestrictedProviderMetaData.Distinct().ToList();
                    if (nonRestrictedProviderMetaDataList.Contains(propertyName))
                    {
