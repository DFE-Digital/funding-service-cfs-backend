...
namespace CalculateFunding.Services.Publishing.Variations.Strategies
{
    public class MidYearReProfilingVariationStrategy : VariationStrategy, IVariationStrategy
    {
        ...
        protected override Task<bool> Determine(ProviderVariationContext providerVariationContext, FundingConfiguration fundingConfiguration = null)
        {
            ...
            {
                newOpenerFundingLines = OpenerFundingLinesToReProfileOnDemand(refreshState);
            }
        ...
        private IEnumerable<string> OpenerFundingLinesToReProfileOnDemand(PublishedProviderVersion refreshState)
        {
            List<string> fundingLines = new List<string>();
