...
namespace CalculateFunding.Services.Publishing.Variations.Strategies
{
    public abstract class VariationStrategy : IVariationStrategy
    {
        ...
        public async Task<bool> Process(ProviderVariationContext providerVariationContext, FundingConfiguration fundingConfiguration = null)
        {
            Guard.ArgumentNotNull(providerVariationContext, nameof(providerVariationContext));

            if (await Determine(providerVariationContext , fundingConfiguration))
            {
        ...
        protected abstract Task<bool> Determine(ProviderVariationContext providerVariationContext, FundingConfiguration fundingConfiguration = null);
