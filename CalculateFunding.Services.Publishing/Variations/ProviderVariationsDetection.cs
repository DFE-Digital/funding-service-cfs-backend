...
namespace CalculateFunding.Services.Publishing.Variations
{
    public class ProviderVariationsDetection : IDetectProviderVariations
    {
        ...
        public async Task<ProviderVariationContext> CreateRequiredVariationChanges(PublishedProvider existingPublishedProvider,
            ...
            IEnumerable<string> variances, FundingConfiguration fundingConfiguration, bool applyReProfileVariationOnDemand)
        {
            ...
            ProviderVariationContext providerVariationContext = new ProviderVariationContext(_policiesService, _logger)
            {
                ...
                IsReProfileVariationAppliedOnDemand = applyReProfileVariationOnDemand
            };
            ...
            foreach (FundingVariation configuredVariation in variations.OrderBy(_ => _.Order))
            {
                ...
                bool stopSubsequentStrategies = await variationStrategy.Process(providerVariationContext, fundingConfiguration);
