...
namespace CalculateFunding.Services.Publishing.Variations
{
    ...
    public class ProviderVariationsApplication : IApplyProviderVariations
    {
        ...
        private bool _isReProfileVariationAppliedOnDemand = false;
        ...
        public bool IsReProfileVariationAppliedOnDemand => _isReProfileVariationAppliedOnDemand;

        public void SetIsReProfileVariationAppliedOnDemand(bool IsReProfileVariationAppliedOnDemand)
        {
            _isReProfileVariationAppliedOnDemand = IsReProfileVariationAppliedOnDemand;
        }
