...
namespace CalculateFunding.Services.Publishing.Variations.Changes
{
    public class ReProfileVariationChange : VariationChange
    {
            ...
            PublishedProviderVersion currentState)
        {
            ...
            //Always trigger reprofiling when invoked from Reprofile on demand
            if (!skipReProfiling || ReProfileRequest.IsReProfileOnDemandTriggered)
            {
            ...
            if (ReProfileRequest.IsReProfileOnDemandTriggered)
            {
                refreshState.AddReprofiledOnDemandProfile(fundingLineCode);
            }
        }
