...
namespace CalculateFunding.Services.Publishing.Variations.Changes
{
    public class AdjustDsgProfilesForUnderOverPaymentChange : ProfileVariationPointerChange
    {
        ...
        protected override void MakeAdjustmentsFromProfileVariationPointer(ProfileVariationPointer variationPointer)
        {
            ...
            //Todo : Need to consider the carry forward value for the 2024 march release. Please see the commit for US 134285 to see the changes
            //Added the fix for DSG issue with 13 periods and multiple profile percentages
            ProfilePeriod periodToAdjust = orderedRefreshProfilePeriods[variationPointerIndex];
            periodToAdjust.ProfiledValue = periodToAdjust.ProfiledValue + fundingChange;
        }
