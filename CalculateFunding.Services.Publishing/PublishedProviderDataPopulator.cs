...
namespace CalculateFunding.Services.Publishing
{
    public class PublishedProviderDataPopulator : IPublishedProviderDataPopulator
    {
        ...
        private IEnumerable<string> _limitedVariances = null;
        ...
        public void SetLimitedVariances(IEnumerable<string> limitedVariances)
        {
            _limitedVariances = limitedVariances;
        }
        /// <summary>
            ...
            IEnumerable<ReProfileAudit> reProfileAudits)
        {
            ...
            if (equal)
            {
                publishedProviderVersionComparer.limitedVariances = _limitedVariances;
