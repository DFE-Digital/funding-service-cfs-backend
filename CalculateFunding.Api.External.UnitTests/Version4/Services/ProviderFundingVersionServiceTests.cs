...
namespace CalculateFunding.Api.External.UnitTests.Version4.Services
{
    ...
    public class ProviderFundingVersionServiceTests
    {
        ...
        private static ProviderFundingVersionService CreateProviderFundingVersionService(ILogger logger = null,
            ...
            IExternalApiFeedWriter externalApiFeedWriter = null,
            ...
            IExternalEngineOptions externalEngineOptions = null)
        {
            return new ProviderFundingVersionService(blobClient ?? CreateBlobClient(),
                ...
                externalApiFeedWriter ?? CreateExternalApiFeedWriterGenerator(),
                publishingResiliencePolicies ?? CreatePublishingResiliencePoliciesGenerator(),
                externalEngineOptions ?? CreateExternalEngineOptionsGenerator());
        }
        ...
        private static IExternalApiFeedWriter CreateExternalApiFeedWriterGenerator()
        {
            return Substitute.For<IExternalApiFeedWriter>();
        }
        private static IPublishingResiliencePolicies CreatePublishingResiliencePoliciesGenerator()
        {
            return Substitute.For<IPublishingResiliencePolicies>();
        }
        private static IExternalEngineOptions CreateExternalEngineOptionsGenerator()
        {
