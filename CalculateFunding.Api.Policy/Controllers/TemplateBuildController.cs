...
namespace CalculateFunding.Api.Policy.Controllers
{
    ...
    public class TemplateBuildController : ControllerBase
    {
        ...
        /// <summary>
        /// Restores a template to its previous version
        /// </summary>
        ...
        //below method use only internal purpose for remove index
        [Route("api/templates/remove-template-index-search/{fundingStreamId}/{fundingPeriodId}/{templateId}")]
        [HttpDelete]
        [ProducesResponseType(200)]
        public async Task RemoveTemplateFormIndexSearch([FromRoute] string fundingStreamId, [FromRoute] string fundingPeriodId, [FromRoute] string templateId) => await _templateSearchService.RemoveTemplateFormIndexSearch(fundingStreamId, fundingPeriodId, templateId);
    }
}