...
namespace CalculateFunding.Api.Policy.Controllers
{
    ...
    public class FundingStreamController : ControllerBase
    {
        ...
        /// <summary>
        /// Get all funding streams for external
        /// </summary>
        /// <returns>A list of funding streams for external without filtering out Parent </returns>
        [HttpGet("api/fundingstreams/external")]
        [Produces(typeof(IEnumerable<FundingStream>))]
        public async Task<IEnumerable<FundingStream>> GetFundingStreamsForExternal()
        {
            return await _fundingStreamService.GetFundingStreamsForExternal();
        }
