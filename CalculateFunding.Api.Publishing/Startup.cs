...
namespace CalculateFunding.Api.Publishing
{
    public class Startup
    {
        ...
        private void RegisterComponents(IServiceCollection builder)
        {
            ...
            builder.AddScoped<IReprofilingStatusService, ReprofilingStatusService>();
            ...
            builder.AddScoped<ICreateJobsForReprofilingOnDemand, ReprofilingOnDemandJobCreation>();
            ...
            builder.AddScoped<IPublishedProviderReprofilingSummaryProcessor, PublishedProviderReprofilingSummaryProcessor>();
