...
{
    public class CosmosProviderSourceDatasetsRepository : IProviderSourceDatasetsRepository
    {
        private readonly ICosmosRepository _cosmosRepository;
        private readonly AsyncPolicy _providerSourceDatasetsRepositoryPolicy;

        public CosmosProviderSourceDatasetsRepository(ICosmosRepository cosmosRepository,
