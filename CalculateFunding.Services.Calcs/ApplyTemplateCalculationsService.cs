...
namespace CalculateFunding.Services.Calcs
{
    public class ApplyTemplateCalculationsService : JobProcessingService, IApplyTemplateCalculationsService
    {
        ...
        public override async Task Process(ServiceBusReceivedMessage message)
        {
            ...
            //below code create the new cals document in cosmos
            ...
            // refresh template mapping  and  update template mapping => update cals ids
        ...
        private string UserPropertyFrom(ServiceBusReceivedMessage message, string key, bool guard = true)
        {
