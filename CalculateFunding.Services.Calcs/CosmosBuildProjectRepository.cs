...
{
    public class CosmosBuildProjectsRepository : IBuildProjectsRepository, IHealthChecker
    {
        private readonly ICosmosRepository _cosmosRepository;

        public CosmosBuildProjectsRepository(ICosmosRepository cosmosRepository)
        {
