                        ...
                        if (dataSetReference == null)
                        {
                            dataSetReference = new DatasetReference
                            {
                                ...
                                DataField = new DataField()
                                {
                                    ...
                                    SchemaFieldId = 
                                        (datasetRelationship.RelationshipType == Models.Datasets.DatasetRelationshipType.Uploaded || datasetRelationship.RelationshipType == Models.Datasets.DatasetRelationshipType.FDS) ?
