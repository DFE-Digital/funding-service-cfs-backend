...
namespace CalculateFunding.Services.Calcs.Caching
{
    public class CodeContextCache : JobProcessingService, ICodeContextCache
    {
        ...
        {
            private JobParameters(ServiceBusReceivedMessage message)
            {
                SpecificationId = MessageProperty(message, "specification-id");
                JobId = MessageProperty(message, "jobId");
            }

            private static string MessageProperty(ServiceBusReceivedMessage message,
                string key)
            ...
            public static implicit operator JobParameters(ServiceBusReceivedMessage message)
            {
