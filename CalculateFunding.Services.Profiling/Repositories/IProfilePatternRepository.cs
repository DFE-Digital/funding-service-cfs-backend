...
namespace CalculateFunding.Services.Profiling.Repositories
{
	public interface IProfilePatternRepository
    {
        ...
        Task<FundingStreamPeriodProfilePattern> GetProfilePattern(string fundingPeriodId, string fundingStreamId, string fundingLineCode, string providerType, DateTimeOffset? DateOpened, string reasonEstablishmentOpened);
    }
}