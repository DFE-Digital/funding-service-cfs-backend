...
{
    [TestClass]
    public class CosmosCalculationResultsRepositoryTests
    {
        private List<PublishedProvider> _providers;
        private ICosmosRepository _cosmosRepository;

        private CosmosCalculationResultsRepository _repository;
        ...
        public void SetUp()
        {
            ...
            _repository = new CosmosCalculationResultsRepository(_cosmosRepository);
        }
        ...
        public async Task IsHealthOkChecksCosmosRepository()
        {
            ...
            isHealthOk
                .Name
                .Should()
                .Be(nameof(CosmosCalculationResultsRepository));
