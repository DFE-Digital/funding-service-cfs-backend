...
namespace CalculateFunding.Services.Results.UnitTests.SearchIndex
{
    ...
    public class ProviderCalculationResultsIndexTransformerTests
    {
        ...
        public void ShouldThrowException_IfConextIsNotProviderCalculationResultsIndexProcessorContextType()
        {
            ...
            ISearchIndexProcessorContext context = new DefaultSearchIndexProcessorContext(ServiceBusModelFactory.ServiceBusReceivedMessage(
        ...
        public async Task ShouldCreateIndex_WhenTransform_GivenProviderResultAndConext()
        {
            ...
            ServiceBusReceivedMessage message = ServiceBusModelFactory.ServiceBusReceivedMessage(
                body: new BinaryData(JsonConvert.SerializeObject(new[] { providerId })),
