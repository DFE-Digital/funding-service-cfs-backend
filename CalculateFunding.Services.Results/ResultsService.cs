...
namespace CalculateFunding.Services.Results
{
    public class ResultsService : JobProcessingService, IResultsService, IHealthChecker
    {
        ...
        public async Task DeleteCalculationResults(ServiceBusReceivedMessage message)
        {
        ...
        public async Task<IActionResult> GetAggregateCalculationResults(string specificationId, IEnumerable<string> calculationIds)
        {
            Guard.IsNullOrWhiteSpace(specificationId, nameof(specificationId));
            Guard.IsNotEmpty(calculationIds, nameof(calculationIds));

            IEnumerable<CalcResultModel.AggregateCalculationResults> aggregateCalculationResults = (await _resultsRepositoryPolicy.ExecuteAsync(() => _resultsRepository.GetAggregateCalculationResults(specificationId,calculationIds))).ToList();

            return new OkObjectResult(aggregateCalculationResults);
        }
        ...
        {
            string specificationId = message.ApplicationProperties["specificationId"].ToString();
