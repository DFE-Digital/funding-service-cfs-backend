...
{
    public class CosmosProviderSourceDatasetRepository : IProviderSourceDatasetRepository, IHealthChecker
    {
        private readonly ICosmosRepository _cosmosRepository;

        public CosmosProviderSourceDatasetRepository(ICosmosRepository cosmosRepository)
        {
        ...
        public Task<ServiceHealth> IsHealthOk()
        {
            ...
            {
                Name = nameof(CosmosProviderSourceDatasetRepository)
            };
