    ...
    public abstract class IoCUnitTestBase
    {
        ...
        protected virtual IConfigurationRoot CreateTestConfiguration()
        {
            var configData = new Dictionary<string, string>
            {
                ...
                {"fdsClient:ApiEndPoint", "https://dev-api-customerengagement.platform.education.gov.uk/fds-public-api/v1/api/"},
                {"fdsClient:ApiKey", "2ba7be3db36449f9af50fcc3c729806d"},
                // Default to empty so AddServiceBus can fall back to development queue registration when tests don't supply a real connection string
