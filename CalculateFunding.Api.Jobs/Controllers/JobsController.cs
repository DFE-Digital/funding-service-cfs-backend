...
namespace CalculateFunding.Api.Jobs.Controllers
{
    public class JobsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetJobsCountBySpecificationIdAndJobDefinitionIdAndStatus([FromQuery] string specificationId, [FromQuery] string jobDefinitionId, [FromQuery] string runningStatus, [FromQuery] string completionStatus)
        {
            return await _jobService.GetJobsCountByJobDefinitionIdAndStatus(specificationId, jobDefinitionId, runningStatus, completionStatus);
        }
