...
namespace CalculateFunding.Api.Calcs.Controllers
{
    public class CalculationsController : ControllerBase
    {
        ...
        [Route("api/calcs/get-compiled-buildproject-by-specification-id")]
        [HttpGet]
        [Produces(typeof(BuildProject))]
        public Task<IActionResult> GetCompiledBuildProjectBySpecificationId([FromQuery] string specificationId
            ) => _buildProjectsService.GetCompiledBuildProjectBySpecificationId(specificationId);
    }
}