    ...
    public class DatasetSearchServiceTests
    {
        ...
        public async Task SearchDatasetVersion_GivenValidParameters_ShouldReturnOkResult()
        {
            ...
            SearchModel model = new SearchModel
            {
                ...
                Filters = new Dictionary<string, string[]>
                {
                    { "datasetId", new[] { "df073a02-bbc5-44ee-a84b-5931c6e7cf1e" }},
                    { "datasetType", new[] { "FDS " } } 
                }
            };
            ...
            {Results = new List<Repositories.Common.Search.SearchResult<DatasetVersionIndex>>
            {
            ...
            mockDatasetVersionIndexRepository
                .Search(Arg.Any<string>(), Arg.Any<SearchParameters>())
                .Returns(mockSearchResults);

            var mockFdsApiClient = CreateFDSApiClient();
            var apiResponse = new Common.ApiClient.Models.ApiResponse<FDSDatasetVersion>(
                statusCode: System.Net.HttpStatusCode.OK,
                content: new FDSDatasetVersion
                {
                    Id = 111,
                    Name = "Test Dataset",
                    FundingDataSchemaId = 111,
                    FundingStreamName = "Test Stream"
                }
            );

            mockFdsApiClient
                .GetDatasetVersionsBySnapshotId(Arg.Any<string>())
                .Returns(apiResponse);

            DatasetSearchService service = CreateDatasetSearchService(
                searchRepositoryDatasetVersion: mockDatasetVersionIndexRepository,
                fDSApiClient: mockFdsApiClient);
            ...
            datasetVersionSearchResults.Should().NotBeNull();
        ...
        static IFDSApiClient CreateFDSApiClient()
        {
