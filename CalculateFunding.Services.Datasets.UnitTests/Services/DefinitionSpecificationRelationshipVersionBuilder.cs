...
namespace CalculateFunding.Services.Datasets.Services
{
    public class DefinitionSpecificationRelationshipVersionBuilder : TestEntityBuilder
    {
        ...
        {
            DatasetRelationshipType[] exceptRelationshipTypes = new DatasetRelationshipType[]
            {
                DatasetRelationshipType.ReleasedData, DatasetRelationshipType.FDS
            };
            return new DefinitionSpecificationRelationshipVersion
            {
                ...
                RelationshipType = _relationshipType ?? NewRandomEnum<DatasetRelationshipType>(exceptRelationshipTypes)
            };
        }
    }
}