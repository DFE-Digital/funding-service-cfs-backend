    ...
    public class IocConfigTests : FunctionIoCUnitTestBase
    {
        protected override Dictionary<string, string> AddToConfiguration()
        {
            return new Dictionary<string, string>
            {
                ...
                // Use empty connection string for ServiceBus settings in unit tests to avoid parsing errors
                ...
                { "releaseManagementSql:ConnectionString", "Server=tcp:sql-t1dv-cfs-v2.database.windows.net,1433;Database=cfs-t1dv-rm-db;" },
            };
        }
