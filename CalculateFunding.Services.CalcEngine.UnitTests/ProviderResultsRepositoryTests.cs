...
using FundingLineResult = CalculateFunding.Repositories.Common.EFCore.EntityModel.FundingLineResult;
using ProviderResult = CalculateFunding.Repositories.Common.EFCore.EntityModel.ProviderResult;

namespace CalculateFunding.Services.Results.UnitTests.Repositories
{
    [TestClass]
    public class ProviderResultsRepositoryTests
    {
