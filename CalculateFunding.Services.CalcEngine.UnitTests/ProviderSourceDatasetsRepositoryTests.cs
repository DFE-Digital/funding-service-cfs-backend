...
namespace CalculateFunding.Services.Calculator
{
    ...
    public class ProviderSourceDatasetsRepositoryTests
    {
        ...
        private CosmosProviderSourceDatasetsRepository _repository;
        ...
        public void SetUp()
        {
            ...
            _repository = new CosmosProviderSourceDatasetsRepository(_cosmosRepository, _resiliencePolicies);
