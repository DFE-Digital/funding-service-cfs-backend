...
namespace CalculateFunding.Services.Calculator
{
    ...
    public class CalculationEngineServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            IEnumerable<DatasetSpecificationRelationshipViewModel> datasetSpecificationRelationshipViewModels = new List<DatasetSpecificationRelationshipViewModel>
            {
                new DatasetSpecificationRelationshipViewModel()
                {
                    ...
                    RelationshipType = Common.ApiClient.DataSets.Models.DatasetRelationshipType.Uploaded
                },
                new DatasetSpecificationRelationshipViewModel()
                {
                    Id = NewRandomString(),
                    Name = NewRandomString(),
                    DatasetId = NewRandomString(),
                    RelationshipType = Common.ApiClient.DataSets.Models.DatasetRelationshipType.FDS
                }
            };
            ...
            _calculationEngineServiceTestsHelper.MockDatasetsApiClient
                .GetRelationshipsBySpecificationId(Arg.Any<string>())
                .Returns(new ApiResponse<IEnumerable<DatasetSpecificationRelationshipViewModel>>(HttpStatusCode.OK, datasetSpecificationRelationshipViewModels));
        ...
        public async Task GenerateAllocations_GivenAValidRequestWhereSaveProviderResultsNotIgnored_ShouldBatchCorrectlyAndSaveProviderResults()
        {
            ...
            {
                ["provider-summaries-partition-index"] = partitionIndex,
                ["provider-summaries-partition-size"] = partitionSize,
                ["provider-cache-key"] = cacheKey,
                ["specification-id"] = specificationId,
                ["jobId"] = specificationId
            };
        ...
        public async Task GenerateAllocations_GivenAValidRequestWhereNoResultsWereReturnedAndFeatureToggleIsEnabled_CallsSaveSevenTimes()
        {
            ...
            IDictionary<string, object> messageUserProperties = new Dictionary<string, object>();
            ...
            ServiceBusReceivedMessage message = ServiceBusModelFactory.ServiceBusReceivedMessage(
                body: new BinaryData(string.Empty),
                properties: messageUserProperties,
                messageId: Guid.NewGuid().ToString());
        ...
        [TestMethod]
        [DataRow("Calculations.Calc1:1,Calculations.Calc2:2,CalculationsCalc3:3")]
        [DataRow("Calculations.calc1:1,Calculations.calc2:2,Calculations.calc3:3")]
        [DataRow("Calculations.cAlC1:1,Calculations.calC2:2,Calculations.CALC3:3")]
            ...
            _calculationEngineServiceTestsHelper
                ...
                .CalculateProviderResults(mockAllocationModel, specificationId, calculationSummaryModelsReturn,
                    ...
                    .Returns(new ProviderResult
                    {
                        CalculationResults = new List<CalculationResult>
                        {
                            new CalculationResult { Value = 10, Calculation = new Common.Models.Reference { Name = "Calculations.Calc1" } },
                            new CalculationResult { Value = 20, Calculation = new Common.Models.Reference { Name = "Calculations.Calc2" } },
                            new CalculationResult { Value = 30, Calculation = new Common.Models.Reference { Name = "Calculations.Calc3" } }
                        }
                    });
