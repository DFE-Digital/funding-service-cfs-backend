...
namespace CalculateFunding.Services.CalcEngine.UnitTests
{
    public class CalculationEngineServiceTestsHelper
    {
        public CalculationEngineServiceTestsHelper()
        {
            ...
            MockCalculatorResiliencePolicies.DatasetsApiClient.Returns(MockDatasetsApiClientPolicy);
        }
        ...
        public IDatasetsApiClient MockDatasetsApiClient { get; set; } = Substitute.For<IDatasetsApiClient>();
        ...
        public AsyncPolicy MockDatasetsApiClientPolicy { get; set; } = Policy.NoOpAsync();
    }
}