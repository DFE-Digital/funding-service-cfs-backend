...
namespace CalculateFunding.Services.Calcs.UnitTests.Caching
{
    ...
    public class CodeContextCacheTests
    {
        ...
        {
            ServiceBusReceivedMessage message = NewMessage(_ => _.WithUserProperty(JobIdKey, NewRandomString()));
        ...
        {
            ServiceBusReceivedMessage message = NewMessage(_ => _.WithUserProperty(SpecificationIdKey, NewRandomString()));
        ...
        public async Task UpdateCodeContextCacheEntryBuildsContextForSuppliedSpecificationIdAndUpdatesCachedEntryWithResult()
        {
            ...
            ServiceBusReceivedMessage message = NewMessage(_ => _.WithUserProperty(SpecificationIdKey, specificationId)
        ...
        private ServiceBusReceivedMessage NewMessage(Action<MessageBuilder> setUp = null)
        {
        ...
        private async Task WhenACodeContextCacheEntryIsUpdated(ServiceBusReceivedMessage message)
